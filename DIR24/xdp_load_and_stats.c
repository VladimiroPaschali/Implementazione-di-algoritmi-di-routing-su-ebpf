...
void mappa(int fdtrie, int fd24 ){
	__u64 counttot=0;
	//inizializza la key per il salvataggio degli ip nel trie
	...
	for(int i=24; i<=32;i++){
		...
		while ((read = getline(&line, &len, fp)) != -1) {
			...
			line[strcspn(line,"\n")]=0;
		  	...
		  	//quelli nell file /24 vengono salvati nell'array
			if(i==24){
