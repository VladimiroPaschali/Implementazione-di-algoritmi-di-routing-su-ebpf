...
void mappa(int fds[]){
	...
	//legge i file da 24 a 32 nella cartella mappe
	for(int i=1; i<=32;i++){
		__u64 count=0;

		if(fds[i-1]==0){
			printf("indice %d=0 mappa dispari\n",i);
			continue;
...
int main(int argc, char **argv)
{
	...
	int fds[]={0,0,0,0,0,0,0,map_lpm8_fd,0,map_lpm10_fd,0,map_lpm12_fd,0,map_lpm14_fd,
	0,map_lpm16_fd,0,map_lpm18_fd,0,map_lpm20_fd,
	0,map_lpm22_fd,0,map_lpm24_fd,0,map_lpm26_fd,0,
	map_lpm28_fd,0,map_lpm30_fd,0,map_lpm32_fd};
